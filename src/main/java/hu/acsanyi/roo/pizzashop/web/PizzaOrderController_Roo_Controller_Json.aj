...
import hu.acsanyi.roo.pizzashop.web.PizzaOrderController;
...
privileged aspect PizzaOrderController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> PizzaOrderController.showJson(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<String> PizzaOrderController.deleteFromJson(@PathVariable("id") Long id) {
        PizzaOrder pizzaOrder = pizzaOrderService.findPizzaOrder(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (pizzaOrder == null) {
